...
public class ChatActivity extends AppCompatActivity implements EMMessageListener{
        ...
        mSendBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!TextUtils.isEmpty(content)) {
                    ...
                    //转换时间格式
                    String msgTime = TimeCycle(message.getMsgTime());
                    // 将新的消息内容和时间加入到下边
                    mContentText.setText(mContentText.getText() + "\n发送：" + content + " - time: " + msgTime);
                    // 调用发送消息的方法
                    ...
                    message.setMessageStatusCallback(new EMCallBack() {
                        ...
                        public void onSuccess() {
                            ...
                            Log.i("TheScar", "send message on success");
                        }

                        @Override
                        public void onError(int i, String s) {
                            // 消息发送失败，打印下失败的信息，正常操作应该去刷新ui
                            Log.i("TheScar", "send message on error " + i + " - " + s);
                        }
    ...
    private void initConversation() {
        ...
        if (mConversation.getAllMessages().size() > 0) {
            ...
            //转换时间格式
            String msgTime = TimeCycle(mConversation.getLastMessage().getMsgTime());
            // 将消息内容和时间显示出来
            mContentText.setText("聊天记录：" + body.getMessage() + " - time: " + msgTime);
        }
    }
        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                case 0:
                    ...
                    String msgTime = TimeCycle(message.getMsgTime());
                    // 将新的消息内容和时间加入到下边
                    mContentText.setText(mContentText.getText() + "\n接收：" + body.getMessage() + " - time: " + msgTime);
                    break;
            }
        }
    };
     ...
     * @return
     */
    public String TimeCycle(long Time){
        SimpleDateFormat simpleDateFormat=new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
        String msgTime = simpleDateFormat.format(Time);
        Log.i("TheScar", msgTime);
        return msgTime;
    }
}
